...
async function validatePackContents() {
  ...
  const requiredPackedFiles = [
    ...
    "scripts/validate-state-architecture.mjs",
    ...
    "docs/operations/state-architecture/state-architecture.manifest.json",
    "docs/operations/state-architecture/state-writer-inventory.json",
    "docs/operations/state-architecture/state-terminal-inventory.json",
    "docs/operations/state-architecture/workspace-isolation-policy.json",
    "docs/operations/state-architecture/bootstrap-review-manifest.json",
    "README.md",
    "README.zh.md",
    "CHANGELOG.md",
    "SECURITY.md",
