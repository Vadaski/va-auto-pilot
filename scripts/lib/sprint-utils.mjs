 ...
 * @property {string} [reviewFallbackCommand]
 * @property {boolean} [reviewRequired]
 * @property {boolean} [allowAdvisoryReview]
 * @property {{required?: boolean}} [review]
 * @property {string} [planReviewCommand]
 * @property {string} [acceptanceTestCommand]
 * @property {string} [evalCommand]
 * @property {Array<{name?: string, command?: string, required?: boolean}>} [evalGates]
 * @property {Array<{name?: string, command?: string, required?: boolean}>} [adaptiveGates]
